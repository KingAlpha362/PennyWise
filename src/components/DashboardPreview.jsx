  ...
  return (
    <section className="relative px-6 md:px-14 py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div id="dashWrap" className="glass-card rounded-2xl overflow-hidden reveal border border-border hero-mockup" role="img" aria-label="Interactive dashboard preview showing total balance, monthly spend, and a cash flow chart">
          {/* Browser chrome */}
